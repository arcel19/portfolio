        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto float-right ml-auto">
                <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                    data-bs-target="#exampleModal"><i class="fa fa-plus"></i> Add a proejet</a>
            </div>
        </div>
    </div>
    <!-- /Page Header -->
                    ...
                    <tbody>
                        @foreach ($projets as $p)
                            <tr>
                                ...
                                <td>{{ $p->lien }}</td>
                                <td>{{ $p->descritpion }}</td>
                                <td> <img class="rounded-circle" src="{{ '/storage/' . $p->photo }}" alt=""
                                        style="width: 40px; height: 40px;"> </td>

                                <td>
                                    <form action="{{ Route('projet.destroy', $p->id) }}" method="POST">
                                        @method('delete')
                                        @csrf
                ...
                <form action="{{ route('projet.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-floating">
                            <textarea class="form-control" name="descritpion" placeholder="Leave a comment here" id="floatingTextarea"
